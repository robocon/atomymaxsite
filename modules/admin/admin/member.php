					...
					?>
                              ...
                              <tr <?php echo $ColorFill; ?>>
                                ...
                                <td colspan="2"><div align="left">
												  <?php  if($dbarr['blog']==0) { echo "<a HREF=?name=admin&file=member&op=member_update&action=update&id=".$dbarr['id']."&status=1><img src=images/publish_x.png alt='"._ADMIN_MEMBER_FORM_ADD_BLOG_OFF."'><font color=#FF0000><b>  "._ADMIN_MEMBER_FORM_ADD_BLOG_OFF."</b></font></a>"; } else { echo "<a HREF=?name=admin&file=member&op=member_update&action=update&id=".$dbarr['id']."&status=0><img src=images/tick.png alt='่"._ADMIN_MEMBER_FORM_ADD_BLOG_OK."'><font color=#00CC00><b>  "._ADMIN_MEMBER_FORM_ADD_BLOG_OK."</b></font></a>"; };?></div></td>
                              </tr>
                              <tr <?php echo $ColorFill; ?>>
