...
?>
                <div style="float:left;">
                    <div class="icon">
                        <a href="<?php echo $arr['menu']['link'];?>">
                        <img src="images/admin/<?php echo $arr['menu']['icon'];?>" alt="<?php echo $arr['menu']['name'];?>" align="middle" border="0" />
                        <span><?php echo $arr['menu']['name'];?></span>
                        </a>
                    </div>
                </div>
<?php 
