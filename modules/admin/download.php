...
//print ("Type : $FILES['type']  \n");
			$upload=@copy( $FILES['tmp_name'], "data/download_".TIMESTAMP."_".$FILES['name']."");
               if ( $upload) {
//              unlink($filesw);
...
//                        print "<center><font color='red'>"._DOWNLOAD_MOD_ERROR1."".$FILES['name']." "._DOWNLOAD_MOD_ERROR2."</font></center><br>";
		$ProcessOutput = "<BR><BR>";
		$ProcessOutput .= "<CENTER><A HREF=\"?name=admin&file=main\"><IMG SRC=\"images/icon/login-welcome.gif\" BORDER=\"0\"></A><BR><BR>";
		$ProcessOutput .= "<center><b><font color='red'>"._DOWNLOAD_MOD_ERROR1."".$FILES['name']." "._DOWNLOAD_MOD_ERROR2."</font></b></center><BR><BR>";
		$ProcessOutput .= "<A HREF=\"?name=admin&file=download\"><B>"._ADMIN_DOWNLOAD_MESSAGE_GOBACK."  </B></A>";
		$ProcessOutput .= "</CENTER>";
		$ProcessOutput .= "<BR><BR>";
                }
