...
<TABLE WIDTH="750"  border="0" ALIGN="center" CELLPADDING="0" CELLSPACING="0">
  ...
  <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td></tr>
  <TR>
        <TD COLSPAN="4"><STRONG><FONT SIZE="4"><IMG SRC="images/human.gif" > <FONT COLOR="#FF3300"><u><FONT COLOR="#0000FF"><?php  echo _MEMBER_MOD_MEMDETAIL_TITLE;?> <?php echo $dbarr['user'] ; ?>
      ...
      <TR>
        ...
        <TD WIDTH="14%" ALIGN="right"><STRONG><?php  echo _MEMBER_MOD_MEMDETAIL_MEMPIC;?> : </FONT></STRONG></TD>
      ...
      <TR>
        ...
        <TD WIDTH="14%" ALIGN="right">&nbsp;</TD>
        <TR>
        <TD WIDTH="24%" ALIGN="right"><STRONG><?php  echo _MEMBER_MOD_MEMDETAIL_ADDRESS;?> : </FONT></STRONG></TD>
        <TD>&nbsp;&nbsp;<?php echo $dbarr['address'] ; ?></FONT></TD>
        <TD WIDTH="14%" ALIGN="right"><STRONG>email : </FONT></STRONG></TD>
        <TD>&nbsp;&nbsp;<?php echo $dbarr['email'] ;?></FONT></TD>
      <TR>
        <TD WIDTH="24%" ALIGN="right"><STRONG><?php  echo _MEMBER_MOD_MEMDETAIL_AMP;?> : </FONT></STRONG></TD>
      ...
      <TR>
        <TD WIDTH="24%" ALIGN="right"> <STRONG><?php  echo _MEMBER_MOD_MEMDETAIL_POST;?> : </FONT></STRONG></TD>
