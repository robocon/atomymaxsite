...
?>
			<TD width="50%" valign=top align=left>	
				...
				<TR>
					...
					<?php NewsIcon(TIMESTAMP, $arr['news']['post_date'], "images/icon_new.gif");?>( <?=$arr['news']['pageview'];?> / <?=$arrs['com']['com'];?> )
				<BR>&nbsp;&nbsp;&nbsp;&nbsp;<?=$details;?><br><?php $rater_ids=$arr['news']['id'];$rater_item_name="news";include("modules/rater/raters.php");?>
					</TD>
				</TR>
				<TR><TD height="3" ></TD></TR>
				</TABLE>
