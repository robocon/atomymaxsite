      ...
      <TBODY>
        <TR>
		  ...
		  &nbsp;&nbsp;<IMG SRC="images/menu/textmenu_gallery.gif" BORDER="0"><BR>
				...
				<TR>
					<TD>
					<A HREF="?name=gallery"><IMG SRC="images/admin/open.gif"  BORDER="0" align="absmiddle"><b><font color="#0033FF" size="2"> <?=_GALLERY_MENU_MAIN;?></A> &nbsp;&nbsp;&nbsp;<?php  if($admin_user){?><A HREF="?name=admin&file=gallery&op=gallery_add"><IMG SRC="images/admin/book.gif"  BORDER="0" align="absmiddle"> <?=_GALLERY_MENU_ADD_IMG;?> </A>  &nbsp;&nbsp;&nbsp;<A HREF="?name=admin&file=gallery_category&op=gallerycat_add"><IMG SRC="images/admin/opendir.gif"  BORDER="0" align="absmiddle"> <?=_GALLERY_MENU_ADD_CAT;?></A><?php }?></font></td></tr>
									<TR>
...
<td  border=0>
<a href="?name=gallery&op=gallery_detail&id=<?php  echo $arr['gallery']['id'];?>">
<img width="<?=_IGALLERYT_W;?>" src="<?php if($arr['category']['id']){ echo "images/gallery/gal_".$arr['gallery']['post_date']."/thb_".$arr['category']['pic'].""; } else { echo "images/news_blank.gif";}?>" />
</a></td>
...
<td valign="top">
<font color="#990000"><b><a href="?name=gallery&op=gallery_detail&id=<?php  echo $arr['gallery']['id'];?>"><?php  echo $arr['gallery']['category_name'];?></b></font></a><?=NewsIcon(TIMESTAMP, $arr['gallery']['post_date'], "images/icon_new.gif");?> ( <?php echo ThaiTimeConvert($arr['gallery']['post_date'],'','');?> ) <?php  if($admin_user){?><a href="?name=admin&file=gallery_category&op=gallerycat_edit&id=<?php  echo $arr['gallery']['id'];?>"><img src="images/admin/edit.gif" border="0" alt="<?=_FROM_IMG_EDIT;?>" ></a> 
      <a href="javascript:Confirm('?name=admin&file=gallery_category&op=gallerycat_del&id=<?php  echo $arr['gallery']['id'];?>&pic=<?php  echo $arr['gallery']['pic'];?>&prefix=<?php  echo $arr['gallery']['post_date'];?>','<?php echo _FROM_COMFIRM_DEL;?>');"><img src="images/admin/trash.gif"  border="0" alt="<?=_FROM_IMG_DEL;?>" ></a><?php }?><br>&nbsp;&nbsp;&nbsp;&nbsp;<?php  echo $arr['gallery']['category_detail'];?>
</td>
</tr>
</table>
</td>
...
?>
 <table width="100%" cellspacing="2" cellpadding="1" >
<tr>
<td bgcolor="#F7F7F7" colspan="<?=_GALLERY_COL;?>"><font color="#990000" size="4"><b> >> <?php  echo $arr['cat']['category_name'];?></b></font></a>  <?=NewsIcon(TIMESTAMP, $arr['cat']['post_date'], "images/icon_new.gif");?> ( <?php echo ThaiTimeConvert($arr['cat']['post_date'],'','');?> )  <br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font><font size="2"><?php  echo $arr['cat']['category_detail'];?>
</font></td>
</tr>
<tr>
...
?>
	 ...
	 <td width="<?=_IGALLERYT_W+35;?>" colspan="2" class='imageframe'>
				...
				<a HREF="images/gallery/<?php  echo "gal_".$CAT."/".$arr['gallery']['pic'];?>" rel="lightbox[slide]" caption="<?php echo $arr['gallery']['pic'];?>"><img class="highslide-display-block" border=0 src="<?php if($arr['gallery']['id']){ echo "images/gallery/gal_".$CAT."/thb_".$arr['gallery']['pic'].""; } else { echo "images/news_blank.gif";}?>" /></a></div></td><a HREF="images/gallery/<?php  echo "gal_".$CAT."/".$arr['gallery']['pic'];?>" rel="lightbox[slide]" caption="<?php echo $arr['gallery']['pic'];?>"></a><td class='shadow_right'><div class='shadow_top_right'></div></td>
</tr>
<tr>
...
<tr>
<td align="right">
<a HREF="index.php?name=gallery&file=readgal&id=<?=$arr['gallery']['id'];?>" ><img src="images/icon-view.gif" border="0"></a> <?php  if($admin_user){?><a href="javascript:Confirm('?name=admin&file=gallery&op=gallery_del&cat=<?php  echo $CAT;?>&id=<?php  echo $arr['gallery']['id'];?>&pic=<?php  echo $arr['gallery']['pic'];?>&cats=<?php  echo $arr['cat']['id'];?>&prefix=<?php  echo $arr['gallery']['post_date'];?>','<?php echo _FROM_COMFIRM_DEL;?>');"><img src="images/admin/trash.gif"  border="0" alt="<?=_FROM_IMG_DEL;?>" ></a><?php }?>
</td>
</tr>
<tr>
